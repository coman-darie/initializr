...
public class ProjectAssert {
	...
	public static final String DEFAULT_PACKAGE_NAME = "com.finastra.chassis.chassisstarter";

	public static final String DEFAULT_APPLICATION_NAME = "ChassisStarterApplication";
