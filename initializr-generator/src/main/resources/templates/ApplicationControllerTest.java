...
public class {{applicationName}}ControllerTest {

    private MockMvc mockMvc;
    @InjectMocks
    private {{applicationName}}Controller chassisStarterApplicationController;
    @Mock
    private {{applicationName}}Service chassisStarterApplicationService;
